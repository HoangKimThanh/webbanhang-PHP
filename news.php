                                    ...
                                    <div class="row">
                                            ...
                                            <a href="#" class="news__featured-item">
                                                <div class="row">
                                                    <div class="col l-3 m-3 c-12">
                                                        <img src="./assets/img/news-1.jpg" alt="" class="news__featured-img">
                                                    </div>
                                        ...
                                        <div class="col l-12 m-12 c-12">
                                            <a href="#" class="news__featured-item">
                                                <div class="row">
                                                    <div class="col l-3 m-3 c-12">
                                                        <img src="./assets/img/news-2.jpg" alt="" class="news__featured-img">
                                                    </div>
                                        ...
                                        <div class="col l-12 m-12 c-12">
                                            <a href="#" class="news__featured-item">
                                                <div class="row">
                                                    <div class="col l-3 m-3 c-12">
                                                        <img src="./assets/img/news-3.jpg" alt="" class="news__featured-img">
                                                    </div>
                                        ...
                                        <div class="col l-12 m-12 c-12">
                                            <a href="#" class="news__featured-item">
                                                <div class="row">
                                                    <div class="col l-3 m-3 c-12">
                                                        <img src="./assets/img/news-4.jpg" alt="" class="news__featured-img">
                                                    </div>
                                ...
                                <div class="news__right">
                                    <div class="news__right-item">
                                        ...
                                        <ul class="news__right-list ">
                                            <li>Pellentesque posuere nisl ut quam ullamcorper, a tincidunt urna bibendum. Aliquam luctus tincidunt eros id.</li>
                                            <li>Pellentesque posuere nisl ut quam ullamcorper, a tincidunt urna bibendum. Aliquam luctus tincidunt eros id.</li>
                                            <li>Pellentesque posuere nisl ut quam ullamcorper, a tincidunt urna bibendum. Aliquam luctus tincidunt eros id.</li>
                                            <li>Pellentesque posuere nisl ut quam ullamcorper, a tincidunt urna bibendum. Aliquam luctus tincidunt eros id.</li>
                                        </ul>
